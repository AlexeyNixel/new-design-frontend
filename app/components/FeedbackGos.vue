...
const loadGosuslugiScript = () =>
  new Promise<void>((resolve, reject) => {
    ...
    script.onerror = () => reject(new Error('Не удалось загрузить виджет Госуслуг'));
